...
const HTML = process.argv[2] || 'previz.html';
const OUT = process.argv[3] || '/tmp/claude-0/-home-user-duvidas-bestas/a71004ea-5bd4-5364-aedd-38d8d5917fc2/scratchpad';
const times = (process.argv[4] || '1.5,4.5,7,15,25.5,29.5,38,49').split(',').map(Number);
